...
<body>
  ...
  <div class="bg-gray-100 flex justify-center items-center h-screen">
    ...
    <div class="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
      <h1 class="text-2xl font-semibold mb-4">Se Connecter</h1>
      <form action="#" method="POST">
        ...
        <!-- Login Button -->
        <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-md py-2 px-4 w-full">Se connecter</button>
      </form>
      <!-- Sign up  Link -->
      <div class="mt-6 text-blue-500 text-center">
        <a href="#" class="hover:underline">S'inscrire ici</a>
      </div>
    </div>
  </div>
</body>
