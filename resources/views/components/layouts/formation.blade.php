    ...
    <div class="container mx-auto max-w-7xl mt-10 px-4 sm:px-6 lg:px-2">
        <div class="flex mt-1 gap-8 items-start">
            <div class="w-[300px] sticky top-0 h-full border-r-2 border-gray-200">
                <!-- component -->
                <div class="relative flex flex-col bg-clip-border rounded-xl ml-0 bg-white text-gray-700 h-[calc(100vh-2rem)] w-full p-4 mb-9 pt-0  shadow-xl shadow-blue-gray-900/5">
                    <div class="mb-2 p-4">
                        <h5 class="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-gray-900">Formations</h5>
                    </div>
                    <nav class="flex flex-col gap-1 w-full p-2 font-sans text-base font-normal text-gray-700">
                        <div role="button" tabindex="0" class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-gray-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                            ...
                            <a href="{{ route('video') }}" class="font-semibold text-black hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                Blocks</a>
                        </div>
