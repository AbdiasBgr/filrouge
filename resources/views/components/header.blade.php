   <nav class="h-max w-full max-w-full rounded-none  border-gray/80 bg-color-primary bg-opacity-80 px-4 text-white shadow-md backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4  ">
        <div>
            <div class="container mx-auto flex items-center justify-between text-white-900 font-bold">
                ...
                <button class="middle none center hidden rounded-lg bg-gradient-to-tr from-orange-600 to-orange-400 py-2 px-4 font-sans text-xs font-bold uppercase text-white shadow-md shadow-orange-500/20 transition-all hover:shadow-lg hover:shadow-orange-500/40 active:opacity-[0.85] active:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block" type="button" data-ripple-light="true">
                    <span>Connexion</span>
                </button>
            ...
            <div class="block h-0 w-full basis-full overflow-hidden text-blue-gray-900 transition-all duration-300 ease-in lg:hidden" data-collapse="navbar">
                <div class="container mx-auto pb-2">
                    ...
                    <button class="middle none center mb-2 block w-full rounded-lg bg-gradient-to-tr from-orange-600 to-orange-400 py-2 px-4 font-sans text-xs font-bold uppercase text-white shadow-md shadow-orange-500/20 transition-all hover:shadow-lg hover:shadow-orange-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button" data-ripple-light="true">
                        <span>Connexion</span>
                    </button>
                </div>
            </div>
