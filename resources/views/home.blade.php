    ...
    <div class="container py-20">
        <div class="flex flex-col items-center z-20 md:flex-row">
            <div class="text-center mb-12 md:text-left md:w-1/2 md:pr-10">
                ...
                <button class="bg-gradient-to-tr from-orange-600 to-orange-400 px-4 py-2 rounded-md font-bold hover:opacity-80 ease-in duration-200"> <a href="#contact">Commencer mon Aventure</a></button>
            </div>
    ...
    <div class="container py-20 relative">
        ...
        <div class="flex flex-col items-center justify-between md:flex-row">
            ...
            <div class="text-center md:text-left md:w-1/2 md:ml-20">
                ...
                <button class="bg-gradient-to-tr from-orange-600 to-orange-400 px-4 py-2 rounded-md font-bold hover:opacity-80 ease-in duration-200"> <a href="#contact">Découvrir Plus</a></button>
            </div>
        </div>
    </div>
</section>
